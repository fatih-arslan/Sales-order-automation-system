...
{
    public partial class KartlaÖdeme : Form
    {        
        public KartlaÖdeme()
        {
            InitializeComponent();
        ...
        {
             if(textBoxAdSoyad.Text != String.Empty && textBoxKartNumara.Text != String.Empty && textBoxCVC.Text != String.Empty && comboBoxAy.SelectedItem != null && comboBoxYıl.SelectedItem != null)
            {
                ...
                DateTime tarih = new DateTime(int.Parse(comboBoxYıl.Text), int.Parse(comboBoxAy.Text), 09);
                double tutar;
                ...
                tutar = Kullanıcı_Girişi.müşteri.Sipariş.SiparişDetayı.ToplamTutar;
                ...
                Kullanıcı_Girişi.müşteri.Sipariş.ÖdemeYöntemi = new Kart()
                {
                    AdSoyad = textBoxAdSoyad.Text,
                    KartNumarası = long.Parse(textBoxKartNumara.Text),
                    GüvenlikKodu = int.Parse(textBoxCVC.Text),
